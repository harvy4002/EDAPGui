...
class Screen_Regions:
    def __init__(self, screen, templ):
        ...
        self.reg['target']    = {'rect': [0.25, 0.22, 0.75, 0.75], 'width': 1, 'height': 1, 'filterCB': self.filter_by_color, 'filter': self.orange_2_color_range}   # also called destination
        self.reg['target_occluded']    = {'rect': [0.25, 0.22, 0.75, 0.75], 'width': 1, 'height': 1, 'filterCB': self.filter_by_color, 'filter': self.target_occluded_range}
